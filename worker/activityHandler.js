...
const unpublish = (req, res) => {
    ...
    async.waterfall([
        ...
        function (arg1, callback) {
            ...
            NPM.unpublish(req.body.activity_name, req.body.activity_version).then(
                function(value) {
                    console.log(value);
                    if(value){
                        callback(null, arg1);
        ...
        function (arg, callback) {
            let result = JSON.parse(arg).Result;

            let data = {
                "notification" : `${req.body.activity_name} Unpublished Successfully`,
                "data" : result
            };
